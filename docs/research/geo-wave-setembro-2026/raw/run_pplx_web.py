...
PRE = (
    "Hoje é 03 de setembro de 2026. Responda em português do Brasil com acentuação completa. Para cada fato: data, fonte nomeada e URL. "
...
for n, p in mod.PPLX.items():
    r = subprocess.run(
        ["node", str(AQUI / "pplx_web.cjs"), "web_" + n, PRE + p],  # nosec B603
        capture_output=True,
        text=True,
        encoding="utf-8",
        errors="replace",
