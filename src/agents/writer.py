...
class Writer(Agent):
    ...
    TEMPLATE = (
        ...
        "MIT Sloan Management Review, HSM Management, IT Forum e Revista Exame.\n\n"
        "DIRETRIZES OBRIGATÓRIAS:\n\n"
        "ESTILO EDITORIAL:\n"
        "- Tom analítico e propositivo, com autoridade intelectual e calor profissional\n"
        "- Profundidade conceitual: vá além de definições, ofereça análises e insights\n"
        "- Abra cada módulo com dado surpreendente, estudo de caso ou pergunta "
        "executiva que explicite o ROI do tempo de leitura\n"
        "- Parágrafos concisos (máximo 5 linhas), uma ideia central por parágrafo\n"
        "- Cada parágrafo deve ensinar algo útil, aplicável ou decisório "
        "para um adulto experiente\n"
        "- Traduza tecnologia em impacto operacional, ROI, governança, risco e trade-offs\n"
        "- Use storytelling de negócios, microcasos e metáforas inteligentes "
        ...
        "- Inclua 2-3 perguntas de autorreflexão executiva sobre maturidade, "
        "ROI, governança, risco ou alocação\n\n"
        ...
        "- Parágrafos justificados: text-justify no React/Tailwind; "
        "<p align=\"justify\"> em export HTML/PDF/e-mail\n\n"
