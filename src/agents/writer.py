...
class Writer(Agent):
    ...
    TEMPLATE = (
        ...
        "- Abra em situação concreta (caso, decisão difícil, dado que contraria a "
        "expectativa), instale a tensão antes da solução e feche retomando o caso da "
        "abertura para mostrar o que mudou\n"
        "- Uma ideia central por parágrafo, desenvolvida até a ideia terminar; o ritmo "
        "vem do conteúdo, sem cota de frase curta nem alternância programada\n"
        "- Elimine clichês: 'nos dias de hoje', 'é fundamental que', 'não é segredo que'\n"
        "- Proibidos: travessão e hífen como recurso estilístico, a construção "
        "'não é X, é Y' como padrão, tríade usada como ritmo, title case em títulos\n\n"
        ...
        "- Abra com o subtítulo em UMA frase, em linha própria, e depois parágrafos "
        "diretos ao ponto; nada entre o título, o subtítulo e o primeiro parágrafo\n"
        ...
        "percurso alternativo ('se você é X vá para Y')\n\n"
        "FORMATAÇÃO:\n"
        ...
        "- Hierarquia clara de títulos (H2 > H3), sem H4\n\n"
