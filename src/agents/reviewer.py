...
class Reviewer(Agent):
    ...
    TEMPLATE = (
        ...
        "- O primeiro parágrafo explicita o ROI do tempo de leitura para o decisor?\n"
        "- Tecnologia vira impacto operacional, ROI, governança, risco e trade-off?\n"
        "- Há storytelling funcional, metáforas inteligentes e 2-3 perguntas "
        "de autorreflexão executiva?\n"
